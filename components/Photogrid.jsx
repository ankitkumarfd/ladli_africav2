  ...
  return (
    <section className={` container mx-auto px-4 my-12 ${className}`}>
      <div className="text-center mb-12">
        <h2
          data-aos="zoom-in"
          className="text-4xl font-bold bg-gradient-to-br from-blue-300 to-blue-800 bg-clip-text text-transparent"
        >
          {heading}
        </h2>
      </div>
      ...
      <div
        data-aos="zoom-out"
        className="w-full h-screen flex items-center justify-center mb-4"
      >
